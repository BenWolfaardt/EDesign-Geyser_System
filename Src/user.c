...
void DecodeCmd()
{
	...
	case 'C' : //Enable/ disable automatic schedule
		//default values OFF
		String2Int(cmdBuf+3, (int16_t*) &scheduleState);
	...
	case 'J' : //Set heating schedule
		//In order to set a heating schedule for the 2nd schedule window,
		//to start at 8:30 AM and end at 10AM, the test station will issue
		// a command: $J,2,8,30,0,10,0,0<CR><LF>
